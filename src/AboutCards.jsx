...
export function Card() {
    ...
    return (
        <>
            <div className="bg-pink-300 rounded shadow-md grid place-items-center p-4 m-5 mt-20 ">
                {/*Profile Picture */}
                ...
                <div className="grid place-items-center">
                    ...
                    <ul className="flex justify-center mb-4">
                        ...
                        <li className="mr-4">
                            <a href="mailto:johndoe@example.com" className="text-gray-600 hover:text-gray-900">
