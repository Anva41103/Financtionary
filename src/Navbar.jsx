            ...
            <div className="flex bglogin">
                <div className="w-full fixed bg-pastel nav-bar flex flex-row justify-between h-16 rounded-2xl ">
                    <div className="flex flex-row gap-10 mx-4 justify-between">
                        ...
                        <Link to="/Login"><button className="m-2 px-4 h-11 rounded-full border-2 active:scale-95 border-slate-300 hover:bg-slate-100 active:bg-slate-200 text-sm sm:text-base">Login</button></Link>
                    </div>
                    <div className="flex flex-row gap-10 mx-4 justify-between">
