            ...
            <div className='bggrad'>
                ...
                <div className="w-full h-[90vh] flex flex-col justify-center items-center flex-wrap main-sec bg-transparent" >
                    ...
                    <div className="mb-7 flex justify-center">
                        {/* <h2 className='sm:text-8xl sm:font-bold font-semibold text-6xl w-[50vw] text-center text-green-400 main-txt pb-5'>Your one step destination for Finance Management */}
                            {/* <span className="text-blue-600">how you ask</span> */}
                        {/* </h2> */}
                    </div>
